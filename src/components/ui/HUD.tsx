    ...
    <div className="absolute inset-0 pointer-events-none z-50">
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div className="bg-black/80 border-2 border-cyan-400 p-4 font-mono text-cyan-400 shadow-[0_0_20px_rgba(0,240,255,0.5)]">
          <div className="text-xs uppercase tracking-wider mb-2">Player 1</div>
          <div className="flex items-center gap-4">
            <div>
              <div className="text-xs text-cyan-400/70 mb-1">Health</div>
            ...
            <div>
              <div className="text-xs text-cyan-400/70 mb-1">Score</div>
              <div className="text-lg font-bold">{player.score}</div>
            </div>
            <div>
              <div className="text-xs text-cyan-400/70 mb-1">Weapon</div>
        ...
        {opponent && (
          <div className="bg-black/80 border-2 border-pink-500 p-4 font-mono text-pink-500 shadow-[0_0_20px_rgba(255,0,255,0.5)]">
            <div className="text-xs uppercase tracking-wider mb-2">Player 2</div>
            <div className="flex items-center gap-4">
              <div>
                <div className="text-xs text-pink-500/70 mb-1">Health</div>
                <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs text-pink-500/70 mb-1">Score</div>
